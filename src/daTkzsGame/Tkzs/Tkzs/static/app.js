...
GameState.prototype.create = function () {
    ...
    var button = this.game.add.button(10, 10, 'button', this.fullScreen, this, 2, 1, 0);
    ...
    SCORE = 0;
    text = this.game.add.text(76, 16, $('#nickname').val() + "'s score: " + SCORE, { font: "32px Arial", fill: "#ffffff" });
};
...
var game = new Phaser.Game(580, 380, Phaser.AUTO, 'game');
